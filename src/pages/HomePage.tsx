...
const HomePage = () => {
  ...
  // Animación para el ecualizador de audio - Simplificada
  const barVariants = {
    playing: (i: number) => ({
      height: ['40%', `${Math.max(60, Math.random() * 90)}%`, '40%'],
      transition: {
          ...
          <div className="flex flex-col md:flex-row bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-gray-900/90">
            ...
            <div className="md:w-3/5 p-8">
              ...
              <div className="mt-auto">
                <div className="mb-2 text-sm font-medium text-gray-400">Escucha ahora:</div>
                <AudioPlayer 
