...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-950 relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-500/0 via-purple-500 to-purple-500/0 blur-[0.5px]"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-3 mb-6 group">
              <div className="bg-purple-900/30 p-2.5 rounded-full group-hover:bg-purple-900/50 transition-all duration-300 backdrop-blur-sm shadow-inner">
                <Headphones size={22} className="text-purple-400 group-hover:text-purple-300 transition-colors" />
              </div>
              <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-200">GoodVibes</span>
            </div>
          ...
          <div>
            <h3 className="text-white font-medium mb-6 text-lg relative inline-block">
              Enlaces Rápidos
              <span className="absolute -bottom-2 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-500 to-purple-500/0"></span>
            </h3>
            <ul className="space-y-4">
              <li>
                <Link to="/" className="text-gray-400 hover:text-white transition-all duration-300 text-sm flex items-center group">
                  <span className="w-1.5 h-1.5 bg-purple-500 rounded-full mr-2.5 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110"></span>
                  Inicio
                </Link>
              </li>
              <li>
                <Link to="/episodios" className="text-gray-400 hover:text-white transition-all duration-300 text-sm flex items-center group">
                  <span className="w-1.5 h-1.5 bg-purple-500 rounded-full mr-2.5 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110"></span>
                  Episodios
                </Link>
              </li>
              <li>
                <Link to="/contacto" className="text-gray-400 hover:text-white transition-all duration-300 text-sm flex items-center group">
                  <span className="w-1.5 h-1.5 bg-purple-500 rounded-full mr-2.5 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110"></span>
                  Contacto
                </Link>
              </li>
